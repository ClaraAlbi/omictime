...
time <- data.table::fread(project_path("clara/blood_sampling_i0.csv")) %>%
...
covs <- data.table::fread(project_path("clara/covariates.csv")) %>%
...
gen_covs <- data.table::fread(project_path("clara/genetic_covs.csv")) %>%
