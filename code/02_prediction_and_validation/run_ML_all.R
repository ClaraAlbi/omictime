...
data_all <- readRDS(project_path("biomarkers_res/res_olink_tech.rds")) %>%
  inner_join(readRDS(project_path("biomarkers_res/res_nmr_tech.rds"))) %>%
  inner_join(readRDS(project_path("biomarkers_res/res_labs_tech.rds"))) %>%
  inner_join(readRDS(project_path("biomarkers_res/res_counts_tech.rds")))
