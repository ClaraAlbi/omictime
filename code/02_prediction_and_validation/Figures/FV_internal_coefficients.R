...
data_all <- readRDS(project_path("biomarkers_3/covariate_res/OLINK/res_olink.rds")) %>%
  inner_join(readRDS(project_path("biomarkers_3/covariate_res/res_nmr.rds"))) %>%
  inner_join(readRDS(project_path("biomarkers_3/covariate_res/res_labs.rds"))) %>%
  inner_join(readRDS(project_path("biomarkers_3/covariate_res/res_counts.rds")))
