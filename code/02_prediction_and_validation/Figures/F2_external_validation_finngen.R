...
time_file <- data.table::fread(project_path("blood_sampling.tsv"))

# Raw proteomics file
olink_raw_file <- data.table::fread(project_path("olink_instance_0.csv"))

# Order of proteins in model
#prot_order <- data.table::fread(project_path("biomarkers_3/2025-04-04_FinnGen_Olink_ProteinList.txt"))
