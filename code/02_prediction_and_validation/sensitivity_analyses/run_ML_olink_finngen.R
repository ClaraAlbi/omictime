...
data_nmr <- readRDS(project_path("biomarkers_3/covariate_res/res_olink.rds")) %>%
  select(eid, any_of(tolower(data.table::fread(project_path("biomarkers_3/2025-04-04_FinnGen_Olink_ProteinList.txt"))$Assay))) %>%
