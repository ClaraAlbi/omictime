...
disease_icd10 <- tribble(
  ...
  # --- Neuro-psychiatric ---
  "recurrent_depression", "ICD10", "F33.0", "Recurrent depressive disorder, current episode mild",
  "recurrent_depression", "ICD10", "F33.1", "Recurrent depressive disorder, current episode moderate",
  "recurrent_depression", "ICD10", "F33.2", "Recurrent depressive disorder, current episode severe without psychotic symptoms",
  "recurrent_depression", "ICD10", "F33.3", "Recurrent depressive disorder, current episode severe with psychotic symptoms",
  "recurrent_depression", "ICD10", "F33.4", "Recurrent depressive disorder, currently in remission",
  "recurrent_depression", "ICD10", "F33.8", "Other recurrent depressive disorders",
  "recurrent_depression", "ICD10", "F33.9", "Recurrent depressive disorder, unspecified",

  "depressive_episode", "ICD10", "F32.0", "Mild depressive episode",
  "depressive_episode", "ICD10", "F32.1", "Moderate depressive episode",
  "depressive_episode", "ICD10", "F32.2", "Severe depressive episode without psychotic symptoms",
  "depressive_episode", "ICD10", "F32.3", "Severe depressive episode with psychotic symptoms",
  "depressive_episode", "ICD10", "F32.8", "Other depressive episodes",
  "depressive_episode", "ICD10", "F32.9", "Depressive episode, unspecified",
