...
col_na_counts <- colSums(is.na(data_nmr))/nrow(data_nmr)

row_na_counts <- rowSums(is.na(data_nmr))

data_nmr_f <- data_nmr[row_na_counts < 1000,col_na_counts < 0.1]

insp <- data_nmr[,col_na_counts < 0.2]
